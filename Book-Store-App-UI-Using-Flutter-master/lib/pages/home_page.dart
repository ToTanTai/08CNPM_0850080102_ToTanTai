...
import 'package:booktore/widgets/avatar_image_person.dart';

import 'package:booktore/widgets/book_card.dart';
import 'package:booktore/widgets/book_cover.dart';
              ...
              children: [
                SizedBox(height: 10,),
                  Container(
                    ...
                    child: Text("Hi, Ebrahim", style: TextStyle(color: secondary,fontSize: 23, fontWeight: FontWeight.w600),),
                  ),
                  SizedBox(height: 10,),
                  Container(
                    margin: EdgeInsets.only(left: 35, right:15),
